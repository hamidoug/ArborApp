...
export default function EndOfWorld({ navigation }) {
  return (
    <FixWhiteSpace>
      <ImageBackground
      ...
      >
        ...
        <Pressable onPress={() => navigation.navigate("AvailableSeeds")}>
          <Image
            source={require("../assets/Images/seedpit.png")}
            style={{
              position: "absolute",
