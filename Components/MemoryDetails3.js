...
export default function MemoryDetails3({ navigation }) {
  ...
  useEffect(() => {
    AsyncStorage.getItem("memoryPeople")
      .then((storedText) => {
        if (storedText) {
  ...
  const handleTextChange = (text) => {
    setInputText(text);
    AsyncStorage.setItem("memoryPeople", text)
      .then(() => {
    ...
    <FixWhiteSpace>
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        ...
        >
          ...
          />
          <Image
            source={require("../assets/Images/memorypeopletext.png")}
            style={{
              position: "absolute",
              top: windowHeight * 0.245,
              left: windowWidth * 0.16,
              height: windowHeight * 0.05, // Adjust the height as needed
              width: windowWidth * 0.37, // Adjust the width as needed
              resizeMode: "cover",
            }}
          />
          <Pressable
          ...
          <TextInput
            style={{
              ...
              width: windowWidth * 0.55, // Adjust the width as needed
